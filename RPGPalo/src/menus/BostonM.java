...
/** A class for the Boston menu. */
public class BostonM extends Menu {

	/** Constructor: the Boston menu */
	public BostonM(RPG rpg) {
		super(rpg);
		...
		buttons[0].setToolTipText("<html>Take a 2-hour bus ride back.<br />Cost: $"
		...
		buttons[3] = new JButton("Har-Verd");
	...
	/** Leave Boston if there are enough time and money. */
	...
	private void sleep(Person p) {
		if (p.getMoney() < 300) {
			JLabel l = new JLabel("<html>You do not have the $300 required to sleep in a hotel. You lose health<br />"
			...
			JLabel l = new JLabel("You sleep in a hotel for $300.");
